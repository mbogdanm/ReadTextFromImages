...
image_folder = r'C:\Users\MIHAL_B1\PycharmProjects\ReadText\images\Korean'  # Change the path to your Chinese images folder
language = 'ko'  # Use 'ch_sim' for Simplified Chinese or 'ch_tra' for Traditional Chinese
output_folder = r'C:\Users\MIHAL_B1\PycharmProjects\ReadText\images\ko_output_images'  # Change the output path accordingly
...
excel_path = os.path.join(excel_folder, 'ko_results.xlsx')
