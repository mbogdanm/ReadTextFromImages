...
image_folder = r'C:\Users\MIHAL_B1\PycharmProjects\ReadText\images\French_Eu_and_Canada'  # Change the path to your Chinese images folder
language = 'fr'  # Use 'ch_sim' for Simplified Chinese or 'ch_tra' for Traditional Chinese
output_folder = r'C:\Users\MIHAL_B1\PycharmProjects\ReadText\images\fr_output_images'  # Change the output path accordingly
...
excel_path = os.path.join(excel_folder, 'fr_results.xlsx')
