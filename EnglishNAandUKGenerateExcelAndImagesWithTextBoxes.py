...
image_folder = r'C:\Users\MIHAL_B1\PycharmProjects\ReadText\images\English_NA and UK'  # Change the path to your Chinese images folder
language = 'en'  # Use 'ch_sim' for Simplified Chinese or 'ch_tra' for Traditional Chinese
output_folder = r'C:\Users\MIHAL_B1\PycharmProjects\ReadText\images\en_output_images'  # Change the output path accordingly
...
excel_path = os.path.join(excel_folder, 'en_results.xlsx')
